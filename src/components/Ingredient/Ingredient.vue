<template>
  <section class="ingredient">
    <img :src="imageUrl" alt="" class="ingredient__image" />
    ...
    <p
      :class="
        freeSpace
          ? 'ingredient__message-invalid'
          : 'ingredient__message-invalid--visible'
      "
    >
...
<style scoped lang="scss" src="./Ingredient.scss"></style>
